...
class ExtensionNet(torch.nn.Module):
    ...
    def calculate_extension(self, x, function_dict, penalty): 
        ...
        if self.args.extension in ['lovasz_old', 'neural']:
    ...
    def get_n_sets(self, x):
        if self.args.extension in ['lovasz', 'lovasz_old', 'neural', 'lovasz_fixed_cardinality', 'lovasz_multi', 'lovasz_bounded_cardinality']:
